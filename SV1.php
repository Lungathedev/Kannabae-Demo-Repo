            ...
            <div class="container-fluid" width="100%">
                <div class="card">
                    ...
                    <div class="card-body vendor-table" >
                         ...
                         <form action="SV2.php" method="get" id="form">
                         <label><strong>Recieving code: </strong></label> <span> </span> <input type="text" name="Vcode" placeholder="Enter verification code" required>
