...
$sql='SELECT * FROM userauth2 WHERE idToken=?';
 ...
 if (!$count>0){
   ...
   if($prepper==$jhb){
$query3="SELECT * FROM orders WHERE idOrderConfirmation='Pending' AND idOrderDate='".$date."' AND idOrderProvince='Gauteng' AND idOrderCity='Johannesburg'";
$result3=mysqli_query($conn,$query3);
$count3=mysqli_num_rows($result3);
 if (!$count3){
    $count3='0';
}
$query1="SELECT * FROM deliverylog WHERE idDate='".$date."' AND idUsername='".$prepper."' AND idProvince='Gauteng' AND idCity='Johannesburg'";
$result1=mysqli_query($conn,$query1);
$count1=mysqli_num_rows($result1);
  if (!$count1){
    $count1='0';
}
$query2="SELECT * FROM deliverylog WHERE idDate='".$date."' AND idPrepperToken='Collected' AND idProvince='Gauteng' AND idCity='Johannesburg'";
$result2=mysqli_query($conn,$query2);
$count2=mysqli_num_rows($result2);
$query4="SELECT * FROM deliverylog WHERE idDate='".$date."' AND idPrepperToken='Delivered' AND idProvince='Gauteng' AND idCity='Johannesburg'";
