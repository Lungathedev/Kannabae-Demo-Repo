...
if($user==$jhb){
$query="SELECT * FROM orderlogs WHERE idOrderStat='".$collected."' AND idDate='".$date."' AND idProvince='Gauteng' AND idCity='Johannesburg'";
$result=mysqli_query($conn,$query);
}
if($user==$pta){
$query="SELECT * FROM orderlogs WHERE idOrderStat='".$collected."' AND idDate='".$date."' AND idProvince='Gauteng' AND idCity='Tshwane/Pretoria'";
$result=mysqli_query($conn,$query);
}
?>
<html lang="en">
