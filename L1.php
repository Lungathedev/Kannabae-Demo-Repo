...
$query="SELECT * FROM deliverylog WHERE idDelivery='".$ordernm."'";
...
$query='SELECT * FROM addresslog WHERE idOrderCustiCode="'.$custi.'" '; 
$result=mysqli_query($conn,$query);
...
<script>
  ...
  gtag('config', 'G-10BFE42JYZ');
    ...
    <title>Kannabae || Driver Agent</title>
            ...
            <div class="container-fluid" width="100%">
                <div class="card">
                    ...
                    <div class="card-body vendor-table" >
                         ...
                         <div>
                         <strong><span>Subscriber cellphone no:</strong><span> </span><?php print_r($row['idContactNumber']); ?></span>
                         <br>
                         <br> 
                         </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 footer-copyright">
                        <p class="mb-0">© 2023 By <strong>K2021661320 (Pty) Ltd</strong></a></p>
                    </div>
