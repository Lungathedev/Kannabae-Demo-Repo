                ...
                <ul class="sidebar-menu">
                    ...
                    <li><a class="sidebar-header" href="#"><i data-feather="chrome"></i><span>Stock management</span></a>
                        <ul class="sidebar-submenu">
                            ...
                            <li><a href="C1.php?username=<?php echo $_GET['username'];?>&auth=<?php echo $_GET['auth'];?>"><i class="fa fa-circle"></i>Verification Codes</a></li>
            ...
            <div class="container-fluid" width="100%">
                <div class="card">
                    ...
                    <div class="card-body vendor-table" >
                         ...
                         <form action="C1.php" method="get" id="form">
                         <input type="hidden" name="auth" value="<?php echo $_GET['auth'] ?>">
                         <input type="hidden" name="username" value="<?php echo $_GET['username'] ?>">
                         <input type="submit" name="Prepared" value="Next" id="Blanks" "/>
                         </form>
                    </div>
                </div>
            </div>
