                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="page-header-left">
                                <h3><span style="color:seagreen;">Kannabae</span> distribution
            ...
            <div class="container-fluid" width="100%">
                <div class="card">
                    ...
                    <div class="card-body vendor-table" >
                         ...
                         <label><strong>Verification code: </strong></label> <span> </span> <input type="text" name="Vcode" placeholder="Enter verification code" required>
                         <input type="submit" name="Submit" value="Submit" id="Blanks">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 footer-copyright">
                        <p class="mb-0">© 2023 By the <strong>Mandla Etfu NPC</strong></p>
                    </div>
