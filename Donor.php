...
<head>
    ...
    <meta name="keywords" content="Kannabae, kannabae, kannabae.org.za, cannabis, cannabis gift, gift of cannabis, Mandla Etfu NPC,indoor cannabis, outdoor cannabis,free cannabis">
    <meta name="author" content="K2021661320 (Pty) Ltd">
<title>Kannabae || Request</title>
<link rel="stylesheet" 
...
<div class="container">
		<div class="plugcontainer">
			<div class="plugheader">
				<h5 class="plugtitleproduct"><strong>ITEM/S</strong></h5>
			...
			<div class="DPelement">
                ...
                <li>	
                <span class = "DPcontainer2BW"><strong>Outdoor - [Sativa]</strong></span>
            </li>
            <li>
			...
			<div class="DPelement">
                ...
                <li>	
                <span class = "DPcontainer2CC"><strong>Outdoor - [Indica]</strong></span>
            </li>
            <li>
		    ...
		    <ion-icon name="caret-up-outline"></ion-icon>
				...
				<li>	
				<span class = "DPcontainer2OC"><strong>Indoor - [Sativa]</strong></span>
			</li>
           ...
           <div class="plugproductsPR">
			...
			<div class="DPelement">
                ...
                <li>	
                <span class = "DPcontainer2PR"><strong>Crushed Indoor - [Indica]</strong></span>
            </li>
            <li>
		    ...
		    <ion-icon name="caret-down-outline"></ion-icon>
			    ...
			    <div class="DPelement">
                    ...
                    <li>	
                    <span class = "DPcontainer2CCES"><strong>Crushed Indoor - [Sativa]</strong></span>
                </li>
                <li>
         ...
         <div class="plugproductsNL">
			...
			<div class="DPelement">
                ...
                <li>	
                <span class = "DPcontainer2NL"><strong>Crushed Outdoor - [Indica]</strong></span>
            </li>
            <li>
        ...
        <div class="plugproductsPE">
			...
			<div class="DPelement">
                ...
                <li>	
                <span class = "DPcontainer2PE"><strong>Crushed Outdoor - [Sativa]</strong></span>
            </li>
            <li>
			...
			<div class="DPelement">
                ...
                <li>	
                <span class = "DPcontainer2"><strong>Indoor - [Indica]</strong></span>
            </li>
            <li>
		...
		<br>
                ...
                <span class="totalCart"><strong>Subscription fee:</strong></span>
                <span class="totalOrder"></span>
                <span class="totalOrderR">R</span>
		<br>
		<span class="totalCart"><strong>Delivery fee:</strong></span>
                <span class="totalDelivery">R45</span>
		<br>
		<span class="totalCart"><strong>Total:</strong></span>
                ...
                <div class="totalsRow">
                <span class="totalCart"><strong>Please confirm that you are requesting the following gift/s listed above</strong></span>
		<div id="nodiscount">
		</div>
		...
		<br>
                ...
                <div class='plugfooterEnd'></div>
                <br>
                <form action="DLV.php" method="get" id="amount">
                <input type="hidden" name="auth" value="<?php echo $_GET['auth'] ?>">
		<input type="hidden" name="username" value="<?php echo $_GET['username'] ?>">
                <input type="hidden" name="totalamount" value="" id="total">
                <input class="orderbutton" type="submit" name="Pay" value="Confirm">
                </form> 
...
let total = localStorage.getItem('totalAmountNumber'); 
total = parseInt(total);
document.getElementById("total").value = total + 45;
}
}, 1000);
setTotal();
</script>
