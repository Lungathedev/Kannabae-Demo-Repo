...
<head>
    ...
    <meta name="description" content="A Cannabis gift requesting tool.">
    <meta name="keywords" content="">
    <meta name="author" content="K2021661320 (Pty) Ltd">
<title>Kannabae || Delivery</title>
<link rel="stylesheet" 
...
<img  src="" /><strong><span>Kannabae</span></strong>
</a></div></div>
...
<div >
	...
	<span class="basel-cart-totals"> 
		...
		</span><span> </span><span><?php echo $total;?></span></span></span> 
        </span> 
	</a>
	</div>
	</div>
...
<form action="https://kannabae.org.za/SC.php" method="get" id="plug" name="moneytree">
...
<select class="JHBtown" name="Towns" id="townsJHB" form="plug" required>
  ...
  <option value="JHB North"  >Johannesburg North</option>
...
<select class="JHBNorthsuburb" name="suburbs" id="suburbsJHBNorth" form="plug" required>
  ...
  <option value="Sophiatown"> Sophiatown </option>
  <option value="Westdene"> Westdene </option>
  <option value="Null" style="display:none" >Null</option>
</select>
</div>
	
<div id="hideAucklandPark" style="display:none">
<label>Street:</label>
<select class="AucklandPark" name="streets" id="streetsAucklandPark" form="plug" required>
  <option value="" disabled selected>Select Street</option>
  <option value="Auckland Avenue"> Auckland Avenue </option>
  <option value="Clievenden Avenue"> Clievenden Avenue </option>
  <option value="Finchley Avenue"> Finchley Avenue </option>
  <option value="Goring Avenue"> Goring Avenue </option>
  <option value="Hurley Road"> Hurley Road </option>
  <option value="Kingsway"> Kingsway </option>
  <option value="Lorthbury Road"> Lorthbury Road </option>
  <option value="Moorgate Road"> Moorgate Road </option>
  <option value="Shiplake Road"> Shiplake Road </option>
  <option value="St Swithins Avenue"> St Swithins Avenue </option>
  <option value="Streatley Avenue"> Streatley Avenue </option>
  <option value="Sunbury Avenue"> Sunbury Avenue </option>
  <option value="Thanet Road"> Thanet Road </option>
  <option value="Walton Avenue"> Walton Avenue </option>
</select>
</div>
	
<div id="hideMelville" style="display:none">
<label>Street:</label>
<select class="Melville" name="streets" id="streetsMelville" form="plug" required>
  <option value="" disabled selected>Select Street</option>
  <option value="1st Avenue"> 1st Avenue </option>
  <option value="1st Street"> 1th Street </option>
  <option value="2nd Avenue"> 2nd Avenue </option>
  <option value="2nd Street"> 2nd Street </option>
  ...
  <option value="5th Street"> 5th Street </option>
  ...
  <option value="8th Avenue"> 8th Avenue </option>
  <option value="8th Street"> 8th Street </option>
  <option value="8th Avenue"> 9th Avenue </option>
  <option value="8th Street"> 9th Street </option>
  ...
  <option value="Carlow Road"> Carlow Road </option>
  <option value="Hill Road"> Hill Road </option>
  <option value="Main Road"> Main Road </option>
  <option value="Main E Road"> Main E Road </option>
  <option value="Rustenburg Road"> Rustenburg Road </option>
  <option value="Null" style="display:none" >Null</option>
</select>
</div>
	
<div id="hideSophiatown" style="display:none">
<label>Street:</label>
<select class="Sophiatown" name="streets" id="streetsSophiatown" form="plug" required>
  <option value="" disabled selected>Select Street</option>
  <option value="Bernard Street"> Bernard Street </option>
  <option value="Bertha Street"> Bertha Street </option>
  <option value="Best Street"> Best Street </option>
  <option value="Coronation Street"> Coronation Street </option>
  <option value="Edith Street"> Edith Street </option>
  <option value="Edward Road"> Edward Road </option>
  <option value="Gerty Street"> Gerty Street </option>
  <option value="Gibson Street"> Gibson Street </option>
  <option value="Gold Street"> Gold Street </option>
  <option value="Good Street"> Good Street </option>
  <option value="Johannes Road"> Johannes Road </option>
  <option value="Limpopo Ct"> Limpopo Ct </option>
  <option value="Link N Street"> Link N Street </option>
  <option value="Link S Street "> Link S Street  </option>
  <option value="Link Straat Suit"> Link Straat Suit </option>
  <option value="Meyer Road"> Meyer Road </option>
  <option value="Meyer Street"> Meyer Street </option>
  <option value="Millar Street"> Millar Street </option>
  <option value="Milner Road"> Milner Road </option>
  <option value="Morris Street"> Morris Street </option>
  <option value="Ray Street"> Ray Street </option>
  <option value="Sol Street"> Sol Street </option>
  <option value="Toby Street"> Toby Street </option>
  <option value="Tucker Street"> Tucker Street </option>
  <option value="Victoria Road"> Victoria Road </option>
  <option value="Willie Street"> Willie Street </option>
  <option value="Null" style="display:none" >Null</option>
</select>
</div>
	
<div id="hideWestdene" style="display:none">
<label>Street:</label>
<select class="Westdene" name="streets" id="streetsWestdene" form="plug" required>
  <option value="" disabled selected>Select Street</option>
  <option value="1st Avenue"> 1st Avenue </option>
  ...
  <option value="4th Avenue"> 4th Avenue </option>
  <option value="5th Avenue"> 5th Avenue </option>
  <option value="Aberdeen Street"> Aberdeen Street </option>
  <option value="Andover Road"> Andover Road </option>
  <option value="Anrundel Road"> Anrundel Road </option>
  <option value="Ararat Street"> Ararat Street </option>
  <option value="Ash Street"> Ash Street </option>
  <option value="Avalanche Street"> Avalanche Street </option>
  <option value="Ayr Road"> Ayr Road </option>
  <option value="Banbury Road  "> Banbury Road   </option>
  <option value="Cadoza Street"> Cadoza Street </option>
  <option value="Chichester Road"> Chichester Road </option>
  <option value="Dover Street"> Dover Street </option>
  <option value="Dublin Road"> Dublin Road </option>
  <option value="East Road"> East Road </option>
  <option value="Glasgow Road"> Glasgow Road </option>
  <option value="Gloucester Street"> Gloucester Street </option>
  <option value="Inverness Road"> Inverness Road </option>
  <option value="Lancaster Road"> Lancaster Road </option>
  <option value="Lewes Road"> Lewes Road </option>
  <option value="Link Street"> Link Street </option>
  <option value="Ludlow Road"> Ludlow Road </option>
  <option value="Maldon Road"> Maldon Road </option>
  <option value="Motor Street"> Motor Street </option>
  <option value="Perth Road"> Perth Road </option>
  <option value="Radnor Street"> Radnor Street </option>
  <option value="Romsey Street"> Romsey Street </option>
  <option value="Seymour Street"> Seymour Street </option>
  <option value="Stafford Street"> Stafford Street </option>
  <option value="Tenby S Street"> Tenby S Street </option>
  <option value="Thornton Road"> Thornton Road </option>
  <option value="Toby Street"> Toby Street </option>
  <option value="Tokio Road "> Tokio Road  </option>
  <option value="Tolip Street"> Tolip Street </option>
  <option value="Warwick Road"> Warwick Road </option>
  <option value="Winchester Street"> Winchester Street   </option>
  <option value="Null" style="display:none" >Null</option>
</select>
</div>
...
<div id="hideContactNumber" style="display:none">
   <label>Recipient contact number:</label><input type="text" name="Contact-number" placeholder="Enter Contact Number" id="Contact" required>
</div>
<div id="hideName" style="display:none">
   <label>Recipient name:</label><input type="text" name="Recipient-number" placeholder="Enter Recipient Name" id="Recipientname" required>
</div>
...
<input type="submit" name="Pay" value="Subscribe">
</form> 
<br>
<span style="display:none;">Fill in form: [<span id="NC" style="color:red">Not completed</span><span id="C" style="color:green;display:none;">Completed</span>]</span>
...
2023 
<span>
By K2021661320 (Pty) Ltd
<br>Check stock availability in your location [<a href="DC.php?auth=<?php echo $_GET['auth'];?>">Here</a>]
<br>Terms and conditions [<a href="A1.php?auth=<?php echo $_GET['auth'];?>">Here</a>]
</span>
<br>How it works [<a href="A3.php?auth=<?php echo $_GET['auth'];?>">Here</a>]</a></div></div></div></div></footer></div>
